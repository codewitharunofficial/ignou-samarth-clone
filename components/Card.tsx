...
const Card = () => {
  return (
    <div className="card w-64 h-44 bg-base-100 shadow-sm rounded-md mt-1 border border-gray-200 py-2 weight-600">
      ...
      <button className="bg-gray-200 text-gray-400 text-xs py-1 px-2 rounded-md mx-4 cursor-pointer hover:text-gray-600 mt-5 font-semibold transition duration-200">
        PROCEED
      </button>
    </div>
  );
